...
namespace BlogManagement.Domain.ArticleAgg
{
    public class Article:EntityBase
    {
        ...
        public void Edit(string title, string shortDescription, string description, string picture, string pictureAlt, string pictureTitle, string slug, DateTime publishDate, string keywords, string metaDescription, string canonicalAddress, long categoryId)
        {
            Title = title;
            ShortDescription = shortDescription;
            Description = description;
