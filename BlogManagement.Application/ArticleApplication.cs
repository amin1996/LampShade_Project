...
namespace BlogManagement.Application
{
    public class ArticleApplication : IArticleApplication
    {
        ...
        public OperationResult Create(CreateArticle command)
        {
            ...
            var article = new Article(command.Title, command.ShortDescription, command.Description, pictureName, command.PictureAlt, command.PictureTitle, publishDate, slug, command.Keywords, command.MetaDescription, command.CanonicalAddress, command.CategoryId);
        ...
        public OperationResult Edit(EditArticle command)
        {
            ...
            article.Edit(command.Title, command.ShortDescription, command.Description, pictureName, command.PictureAlt, command.PictureTitle, slug, publishDate, command.Keywords, command.MetaDescription, command.CanonicalAddress, command.CategoryId);
